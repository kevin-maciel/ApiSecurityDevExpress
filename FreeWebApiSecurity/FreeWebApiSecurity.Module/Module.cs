...
using Updater = FreeWebApiSecurity.WebApi.DatabaseUpdate.Updater;
...
public sealed class FreeWebApiSecurityModule : ModuleBase {
    public FreeWebApiSecurityModule() {
		...
		// 
		AdditionalExportedTypes.Add(typeof(FreeWebApiSecurity.WebApi.BusinessObjects.ApplicationUser));
